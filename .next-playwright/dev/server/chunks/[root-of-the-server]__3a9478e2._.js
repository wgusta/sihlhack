...
function proxy(request) {
    ...
    if (isCompanyRoute) {
        ...
        if (!companyToken) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(registerUrl);
        }
    }
