...
export function EnergyTrilemmaSection() {
  ...
  const thermalPaths = [
    ...
    },
    {
      ...
      description: 'Server-Wärme (45-55°C) als Quelle für eine Wärmepumpe. Wird auf 70°C+ gehoben, genug für Radiatoren. Aber: Komplexität. COP-Trade-offs. Stromverbrauch der Pumpe. Für Teams, die ambitioniert denken.',
